...
const InsertRecipt = async (data) => {
    ...
    try {
        ...
        const info = stmt.run(data.rno, data.name, data.pnumber, data.email, data.pmethod, data.amount, data.baccount, data.project);
...
exports.InsertRecipt = InsertRecipt;
//------------retrieve---------------
const getRecipts = async (id) => {
...
exports.getRecipts = getRecipts;
//-------update-----------
const updateRecipts = async (dirtyfields, id) => {
...
exports.updateRecipts = updateRecipts;
//-----------delete-----------
const DeleteRecipts = async (id) => {
    const db = new better_sqlite3_1.default(process.env.DB_NAME);
    db.pragma('journal_mode = WAL');
    try {
...
exports.DeleteRecipts = DeleteRecipts;
const SelectAllRecipts = async () => {
    const db = new better_sqlite3_1.default(process.env.DB_NAME);
    db.pragma('journal_mode = WAL');
    try {
...
exports.SelectAllRecipts = SelectAllRecipts;
/////////////////////////////////////////////////////////////////
