        ...
        <div className="bg-gray-100 p-6 rounded-md shadow-md w-[80%]">
          ...
          <form>
            <div className="mb-4 grid grid-cols-2 gap-8">
              <Label htmlFor="hotel" className="block text-sm font-medium text-end mt-4" >
                Hotel
              </Label>
              <Input
                type="text"
            ...
            <div className="mb-4 grid grid-cols-2 gap-8">
              <Label htmlFor="checkin" className="block text-sm font-medium text-end mt-4">
                Check In Date
              </Label>
              <Input
                type="date"
            ...
            <div className="mb-4 grid grid-cols-2 gap-8">
              <Label htmlFor="checkout" className="block text-sm font-medium text-end mt-4">
                Check Out Date
              </Label>
              <Input
                type="date"
            ...
            <div className="mb-4 grid grid-cols-2 gap-8">
              <Label htmlFor="promo" className="block text-sm font-medium text-end mt-4">
                Promotion Code
              </Label>
              <Input
                type="text"
            ...
            <div className="mb-4 grid grid-cols-2 gap-8">
              <Label className="block text-sm font-medium text-end">Are you Sri Lankan?</Label>
