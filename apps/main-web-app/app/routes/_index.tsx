    ...
    <div className="font-sans">
      ...
      <header className="bg-blue-900 text-white flex justify-between items-center px-6 py-4">
        ...
        <nav className="flex space-x-4">
          <Button className="text-white border-white hover:bg-slate-800 hover:text-white">
            SignUp
          </Button>
          <Button className="text-white border-white hover:bg-slate-800 hover:text-white">
            Login
      ...
      >
        ...
        <div className="relative z-10 text-center text-white">
          ...
          <Link
            className="bg-slate-300 text-blue-900 px-6 py-3 rounded-md hover:bg-white"
            to={'/creat-organization'}
          >
            Create Organization
          </Link>
        </div>
