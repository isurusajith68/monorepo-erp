...
function BookingListPage() {
    ...
    return (<div>
      <div className="flex items-center  justify-between ml-10 mt-5">
        ...
        <button_1.Button onClick={() => navigate('/booking/add')} className="bg-green-600">
          + Add
        </button_1.Button>
      </div>
      ...
      <table_1.Table className="rounded-xl overflow-hidden mt-10">
        <table_1.TableHeader className="bg-green-300 text-center">
          <table_1.TableRow>
            ...
            <table_1.TableHead className="text-center">Room Price </table_1.TableHead>
        ...
        <table_1.TableBody className="bg-green-50">
          {booking.map((booking) => (<table_1.TableRow key={booking.id}>
              ...
              <table_1.TableCell className="text-center">{booking.roomprice}</table_1.TableCell>
                ...
                <alert_dialog_1.AlertDialog>
                  ...
                  <alert_dialog_1.AlertDialogContent>
                    ...
                    <alert_dialog_1.AlertDialogFooter>
                      ...
                      <alert_dialog_1.AlertDialogAction className="bg-red-600" onClick={() => deleteAction(booking.id)}>
                        Delete
