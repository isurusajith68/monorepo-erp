      ...
      <section id="room" className="py-16 bg-gray-100">
        <div className="container mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ml-5 mr-5">
            {rooms.map((room, index) => (<div key={index} className="bg-white rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="p-6">
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="flex items-center">
                      {[...Array(room.rating)].map((_, i) => (<i key={i} className="fa fa-star text-yellow-500"></i>))}
                    </div>
                  </div>
                  ...
                  <ul className="flex space-x-4 text-gray-600 mt-4">
                    <li>
                      <i className="fa fa-bed"></i> {room.roombeds} Bed
                    </li>
                    <li>
                      <i className="fa fa-bath"></i> {room.roombath} Bath
                    </li>
                    {room.otherfacility && (<li>
                        <i className="fa fa-wifi"></i> {room.otherfacility}
                      </li>)}
                  </ul>
                  <p className="text-gray-600 mt-4">{room.roomsdescription}</p>
