...
const Home = ({ data, image }) => {
    ...
    return (<div>
      {/* Display Hotel Data */}
      {Data.length > 0 ? (Data.map((hotel, index) => (<div key={index}>
            {/* Hotel Info Section */}
            <div className="bg-blue-900 text-white z-0 relative">
              ...
              {Image.length > 0 && Image[0].image && (<div className="relative bg-cover bg-center h-[600px] z-0" style={{
                    backgroundImage: `url(${Image[0].image})`, // Use the first image as the background
                }}>
