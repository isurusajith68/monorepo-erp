...
const home_page_1 = require("./_component/home-page");
const axios_1 = require("axios");
const about_us_page_1 = require("./_component/about-us-page");
const service_page_1 = require("./_component/service-page");
const room_page_1 = require("./_component/room-page");
const contact_page_1 = require("./_component/contact-page");
const footer_page_1 = require("./_component/footer-page");
function Template1() {
    ...
    return (<div className="w-full">
      ...
      <service_page_1.default data={data}></service_page_1.default>
      <room_page_1.default data={data}></room_page_1.default>
