...
const Navbar = () => {
    return (<header className="fixed top-0 z-50 flex h-14 items-center gap-4 border-b  backdrop-blur-md px-4 lg:h-[60px] lg:px-6 bg-blue-400 w-full">
      {' '}
      {/*bg-white/90*/}
      ...
      <sheet_1.Sheet>
        ...
        <sheet_1.SheetContent side="left" className="flex flex-col">
          <nav className="grid gap-2 text-lg font-medium">
            <react_1.Link to="#" className="flex items-center gap-2 text-lg font-semibold">
              <lucide_react_1.Package2 className="h-6 w-6"/>
              <span className="sr-only">Acme Inc</span>
            </react_1.Link>
            <react_1.Link to="/" className="mx-[-0.65rem] flex items-center gap-4 rounded-xl px-3 py-2 text-muted-foreground hover:text-foreground">
              <lucide_react_1.Home className="h-5 w-5"/>
              Dashboard
            </react_1.Link>
            <react_1.Link to="/orders" className="mx-[-0.65rem] flex items-center gap-4 rounded-xl bg-muted px-3 py-2 text-foreground hover:text-foreground">
            ...
            <react_1.Link to="/products" className="mx-[-0.65rem] flex items-center gap-4 rounded-xl px-3 py-2 text-muted-foreground hover:text-foreground">
              <lucide_react_1.Package className="h-5 w-5"/>
              Products
            </react_1.Link>
            <react_1.Link to="/customers" className="mx-[-0.65rem] flex items-center gap-4 rounded-xl px-3 py-2 text-muted-foreground hover:text-foreground">
              <lucide_react_1.Users className="h-5 w-5"/>
              Customers
            </react_1.Link>
            <react_1.Link to="/analytics" className="mx-[-0.65rem] flex items-center gap-4 rounded-xl px-3 py-2 text-muted-foreground hover:text-foreground">
