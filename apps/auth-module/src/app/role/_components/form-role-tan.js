      ...
      <form className="" onSubmit={(e) => {
        ...
        <div className="border-2 rounded-lg border-green-300 p-4 bg-green-100 ">
          <table_1.Table className="">
            ...
            <table_1.TableBody>
              <form.Field name="interests" mode="array" children={(field) => (<>
                    {field.state.value.map((_, index) => (<div key={index} className="flex gap-2 my-2">
                        <table_1.TableRow>
                          <form.Field name={`interests[${index}].id`} children={(subField) => (<table_1.TableCell className="">
                    ...
                    <button_1.Button type="button" variant={'outline'} onClick={() => field.pushValue('')}>
                      Add
                    </button_1.Button>
                  </>)}/>
