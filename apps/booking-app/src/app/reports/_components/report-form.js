...
const Report = () => {
    return (<>
      ...
      <div className="mt-5 flex items-center ml-10 ">
        ...
        <button_1.Button>Booked Rooms</button_1.Button>
      </div>
      <div>
        <table_1.Table>
          <table_1.TableHeader>
          ...
          <table_1.TableBody>
            <table_1.TableRow>
              <table_1.TableCell className="text-center">INV001</table_1.TableCell>
              <table_1.TableCell className="text-center">Paid</table_1.TableCell>
              <table_1.TableCell className="text-center">Credit Card</table_1.TableCell>
              <table_1.TableCell className="text-center">$250.00</table_1.TableCell>
              <table_1.TableCell className="text-center">INV001</table_1.TableCell>
              <table_1.TableCell className="text-center">Paid</table_1.TableCell>
              <table_1.TableCell className="text-center">Credit Card</table_1.TableCell>
